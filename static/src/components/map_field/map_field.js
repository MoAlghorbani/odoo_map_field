    ...
    setup() {
        ...
        onMounted(() => {
            ...
            this.map.on('click', (e) => {
                ...
                this.props.record.update({ [this.props.name]: `${lat},${lng}` });
            })
    ...
    async getCurrentLocation() {
        if ("geolocation" in navigator) {
            try {
                ...
                await this.props.record.update({ [this.props.name]: `${latitude},${longitude}` });
            } catch (error) {
...
MapField.template = "survey_form.MapField";
